...
<%--      <form:input id="brand" path="brand" placeholder="Enter the brand name" class="form-control input-md" required="" type="text"/> --%>
  ...
  <option value="formalshirt">Formal Shirts</option>
  <option value="plainshirt">Plain Shirts</option>
  <option value="checkedShirts">Checked Shirts</option>
   <option value="printedshirts">Printed Shirts</option>
    <option value="formalpants">Formal Pants</option>
     <option value="shorts"> Shorts</option>
      <option value="jeanpants">Jeans Pants</option>
       <option value="checkedpants">Checked Pants</option>
...
<%--      <form:input id="material" path="material" placeholder="Enter the material name" class="form-control input-md" required="" type="text"/> --%>
  ...
  <option value="footwear">Shoe</option>
